...
function onecommunity_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'         => 'https://diaboliquedesign.com/bundled-plugins/onecommunity-shortcodes.zip',
        ...
        array(
            ...
            'source'         => 'https://diaboliquedesign.com/bundled-plugins/ajax-search-pro.zip',
        ...
        array(
            ...
            'source'         => 'https://diaboliquedesign.com/bundled-plugins/dd-hide-admin-bar.zip',
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
...
function onecommunity_course_duration_wrapper() { 
    echo '<span class="course-duration">';
    echo esc_attr__('Duration', 'onecommunity') . " ";
    onecommunity_course_duration();
    echo '</span>';
}

remove_action( 'learn-press/after-courses-loop-item', 'learn_press_courses_loop_item_price', 20 );
add_action( 'learn-press/courses-loop-item-details-top-price', 'learn_press_courses_loop_item_price', 10 );
remove_action( 'learn-press/after-courses-loop-item', 'learn_press_course_loop_item_buttons', 35 );
add_action( 'learn-press/courses-loop-item-details-top-category', 'onecommunity_course_category', 10 );
add_action( 'learn-press/after-courses-loop-item', 'onecommunity_course_duration_wrapper', 26 );

remove_action( 'learn-press/before-main-content', 'learn_press_breadcrumb', 10 );
add_action( 'learn-press/breadcrumbs', 'learn_press_breadcrumb', 10 );
remove_action( 'learn-press/content-landing-summary', 'learn_press_course_students', 10 );
add_action( 'learn-press/lp-single-details-list-end', 'learn_press_course_students', 11 );
...
add_action( 'learn-press/lp-single-details-begin', 'learn_press_course_price', 10 );
add_action( 'learn-press/lp-single-details-end', 'learn_press_course_buttons', 30 );
